...
export const SaveDataComponent = observer(props => {
	return (
		<React.Fragment>
			...
			<input type="hidden" name={'kaliforms[scroll_to_thank_you]'} value={store._FORM_INFO_.scrollToThankYou || ''} />
			...
			<input type="hidden" name={"kaliforms[redirect_timeout]"} value={store._FORM_INFO_.redirectTimeout || 5} />
